...
def Chi2Fig(cha, complex=False, new_dict = False, replace_dict=dict()):
    ...
    dict_complex = {'空': 0, '壹': 1, '貳': 2, '參': 3, '參': 3, '肆': 4, '伍': 5, '陸': 6, '柒': 7, '捌': 8, '玖': 9, '拾': 10, '拾': 10, '百': 100, '千': 1000, '萬': 10000}
    dict_simple = {'空':0, '一': 1, '二': 2, '三': 3, '四': 4, '五': 5, '六': 6, '七': 7, '八': 8, '九': 9, '十': 10, '百': 100, '千': 1000, '萬': 10000}
...
def ganji_gap(a, b): # a가 b보다 최신 년도 간지라고 가정
    ...
    ar = list_ganji_kor.index(a)
    br = list_ganji_kor.index(b)
    if ar>br:
        rs = ar-br
    elif ar<br:
        rs = 60-(br-ar)
